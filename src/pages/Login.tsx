...
export function Login() {
  ...
  return (
    <div className="flex min-h-svh items-center justify-center bg-bg px-4 py-8">
      <div className="w-full max-w-sm">
        ...
        <form
          ...
          className="rounded-xl border border-border bg-surface p-5 shadow-lg sm:p-8"
        >
          <div className="mb-4">
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="••••••••••"
                className="w-full rounded-lg border border-border bg-surface-raised px-3 py-2.5 pr-11 text-sm text-text placeholder:text-text-faint focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
              />
              <button
                type="button"
                onClick={() => setShowPassword((v) => !v)}
                aria-label={showPassword ? 'Hide password' : 'Show password'}
                className="absolute right-1.5 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded text-text-faint hover:text-text"
              >
